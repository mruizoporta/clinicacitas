...
var defaults = {
	...
	dayNames: ['Domingo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabdo'],
...
function BasicView(element, calendar, viewName) {
	...
	function renderSelection(startDate, endDate, allDay) {
		...
		document.getElementById('fechaselect').innerHTML = fechaseleccionada;  
		var data = $(this).find('td').data('date');
  		console.log(data);
